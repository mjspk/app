...
@Component({
  selector: 'app-text-audio-downloader',
  templateUrl: './text-audio-downloader.component.html',
  styleUrls: ['./text-audio-downloader.component.css']
})
export class TextAudioDownloaderComponent {
